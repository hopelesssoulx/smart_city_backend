...
exports.getImages = (req, res) => {
    // const filePath = path.resolve(__dirname, `../public/images/carousel/${req.params[0]}`)
    ...
    //     res.cc('文件不存在')
    // }
    res.sendFile(path.join(__dirname, `../public/images/carousel/${req.params[0]}`))
}
...
exports.uploadImages = (req, res) => {
    ...
    const targetPath = path.join(__dirname, `../public/images/carousel/${date}__${name}`);
